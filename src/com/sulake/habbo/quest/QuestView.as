package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_100:Quest;
      
      private var _view:IWindow;
      
      private var var_1412:int;
      
      private var var_1885:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_100.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_1885 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this._view)
               {
                  throw new Error("[QuestView] Could not create view for quest type: " + this.var_100.type + " !");
               }
               return;
               break;
            default:
               throw new Error("[QuestView] View not defined for quest type: " + this.var_100.type + " !");
         }
      }
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_100)
         {
            this.var_67.controller.activateQuest(this.var_100);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc33_:* = null;
         var _loc34_:* = null;
         var _loc1_:String = ["quest",this.var_67.id,this.var_100.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_67.id,"type_" + this.var_100.type.toLowerCase()].join(".");
         ...
         if(this.var_100.type == QuestTypeEnum.FIND_STUFF)
         {
            _loc32_ = this.var_67.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_100.roomItemTypeName);
            if(_loc32_)
            {
               _loc33_ = this.var_67.controller.questEngine.roomEngine.getFurnitureImage(_loc32_.id,new Vector3d(90,0,0),64,this,"");
               this.var_1412 = _loc33_.id;
         ...
         else if(this.var_100.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
         ...
         switch(this.var_100.status)
         {
            case QuestStatusEnum.const_397:
         ...
         this.var_67.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_100.rewardCurrencyAmount.toString());
         this.setText("quest.reward.title",_loc13_);
         this.setText("quest.reward.desc",_loc14_);
         var _loc19_:int = this.var_100.endDate.date;
         var _loc20_:int = this.var_100.endDate.month + 1;
         var _loc21_:int = this.var_100.endDate.fullYear;
         var _loc22_:int = this.var_100.endDate.minutes;
         var _loc23_:int = this.var_100.endDate.hours;
         ...
         var _loc31_:String = "icon_" + this.var_67.id + "_reward_" + this.var_100.rewardCurrencyAmount;
