package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      private const const_1838:int = 2;
      ...
      private var var_1188:IMessageConfiguration;
      ...
      {
         this.var_1188 = new HabboMessages();
         this.var_242 = [];
         this.var_1340 = new Timer(100,1);
      ...
      {
         if(this.var_242.length == 0 || this.var_389 < 0 || this.var_389 >= this.var_242.length)
         {
            return 0;
         }
         return this.var_242[this.var_389];
      }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_281.registerProtocolType(HabboProtocolType.const_1027,WedgieProtocol);
            this._connection = this.var_281.createConnection(HabboConnectionType.const_250,ConnectionType.const_979);
            _loc3_ = this.var_281.getProtocolInstanceOfType(HabboProtocolType.const_1027);
            this._connection.registerMessageClasses(this.var_1188);
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!_loc4_)
            {
               Core.crash("Tried to connect to an invalid host: " + this.var_33,Core.const_306);
               return;
            }
            _loc5_ = _loc3_.split(",");
      ...
      private function nextPort() : void
      {
         ...
         ++this.var_389;
         if(this.var_389 >= this.var_242.length)
         {
            ErrorReportStorage.addDebugData("ConnectionRetry","Connection attempt " + this.var_865);
            ++this.var_865;
            _loc1_ = this.const_1838;
            if(this.var_242.length == 1)
            {
               _loc1_++;
            }
            if(this.var_865 > _loc1_)
            {
               if(this.var_2392)
               {
                  return;
               ...
               this.var_2392 = true;
               Core.error("Connection failed to host " + this.var_33 + " ports " + this.var_242,true,Core.const_306);
               return;
            }
            this.var_389 = 0;
         }
         this._connection.timeout = this.var_865 * 10000;
         this._connection.init(this.var_33,this.var_242[this.var_389]);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication IO Error","IOError " + param1.type + " on connect: " + param1.text + ". Port was " + this.var_242[this.var_389]);
         this.tryNextPort();
      }
      
      private function onConnect(param1:Event) : void
      {
         ErrorReportStorage.addDebugData("Connection","Connected with " + this.var_865 + " attempts");
      }
      
      private function tryNextPort() : void
      {
         this.var_1340.addEventListener(TimerEvent.TIMER,this.onTryNextPort);
         this.var_1340.start();
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication Security Error","SecurityError on connect: " + param1.text + ". Port was " + this.var_242[this.var_389]);
         this.tryNextPort();
      }
      
      public function getHabboMainConnection(param1:Function) : IConnection
      {
         return !!this.var_281 ? this.var_281.queueConnection(HabboConnectionType.const_250,param1) : null;
      }
      ...
      public function addHabboConnectionMessageEvent(param1:IMessageEvent) : void
      {
         if(this.var_281)
         {
            this.var_281.addConnectionMessageEvent(HabboConnectionType.const_250,param1);
         }
      }
      ...
      public function connectionInit(param1:String, param2:int) : void
      {
         ...
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1306,String(param2));
      }
      ...
      public function messageSent(param1:String, param2:String) : void
      {
         ...
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1356,param1 + " " + param2);
         if(this.var_123.length > 0)
         {
