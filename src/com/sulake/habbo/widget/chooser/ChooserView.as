package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1842:uint = 4.282169599E9;
      ...
      {
         var _loc2_:* = null;
         if(this._itemList == null || param1 < 0 || param1 > this._itemList.numListItems || param1 == this.var_871)
         {
            return;
         }
         if(this.var_871 != -1)
         {
            _loc2_ = this._itemList.getListItemAt(this.var_871) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_871 % 2) ? uint(this.const_1570) : uint(this.const_1569);
            }
         }
         _loc2_ = this._itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = this.const_1842;
            this.var_871 = param1;
         }
      }
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         this.populate(this._items,this.var_1727);
      }
