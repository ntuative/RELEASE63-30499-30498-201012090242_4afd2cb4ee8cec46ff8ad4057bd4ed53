package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1104:MeMenuSoundSettingsView;
      ...
      public function set min(param1:Number) : void
      {
         ...
         this.setValue(this.var_1104.volume);
      }
      ...
      {
         return param1 / this.var_1486 * (this.var_1124 - this._minValue) + this._minValue;
      }
      
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type != WindowEvent.const_371)
         {
            return;
         }
         this.var_1104.saveVolume(this.getValue(param2.x),false);
      }
