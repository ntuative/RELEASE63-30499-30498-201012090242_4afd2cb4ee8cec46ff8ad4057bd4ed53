   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_825 != null)
         {
            if(this.var_160.isActive)
            {
               ...
               this.var_825.width = _loc2_ * this.var_483;
            }
            else
            {
               this.var_825.width = 0;
               this.var_182.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_826 = this._window.findChildByName("effect_hilite");
            this.var_826.visible = false;
         }
         this.var_824 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_825 = this._window.findChildByName("loader_bar");
         if(this.var_825 != null)
         {
            this.var_483 = this.var_825.width;
            this.var_182.start();
            this.onUpdate();
         }
