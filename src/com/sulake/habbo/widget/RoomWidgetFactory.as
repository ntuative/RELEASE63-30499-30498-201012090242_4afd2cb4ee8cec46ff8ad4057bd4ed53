      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_335:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this._localizations,this.var_125,this.var_2071++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this._localizations,this);
               break;
            case RoomWidgetEnum.const_479:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this._localizations,this.var_125,this._catalog);
               break;
            case RoomWidgetEnum.const_472:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this._localizations,events,this.var_125);
               break;
            ...
            case RoomWidgetEnum.const_417:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this._localizations,this.var_125);
               break;
            case RoomWidgetEnum.const_681:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this._localizations,this.var_125);
               break;
            case RoomWidgetEnum.const_105:
               _loc2_ = new VoteWidget(this._windowManager,assets,this._localizations,this.var_125);
               break;
