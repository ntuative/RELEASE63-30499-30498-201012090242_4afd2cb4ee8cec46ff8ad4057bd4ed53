package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_821 = this.var_199.findChildByTag("catalog");
         if(this.var_821 != null)
         {
            this.var_821.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_50.addListItem(this.var_821);
            }
            this.var_821.visible = param1;
         }
         else
         {
            this.var_50.removeListItem(this.var_821);
         }
      }
   }
}
