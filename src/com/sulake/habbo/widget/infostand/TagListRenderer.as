package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1813:int = 5;
      ...
      private var var_965:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_966 = 0;
         this.var_965 = param2.rectangle.clone();
         this.var_965.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_965.width)
         {
            return false;
         }
         if(this.var_966 + param1.height > this.var_965.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_965.width)
         {
            this._offsetX = 0;
            this.var_966 += param1.height + this.const_1814;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_966);
         this._offsetX += param1.width + this.const_1813;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1215 != null && this.var_1215.indexOf(param1) != -1)
         {
