package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1822:int = 158;
      ...
      private const const_1819:uint = 3355443;
      
      private const const_1826:String = "level";
      
      private const const_1823:String = "experience";
      
      private const const_1824:String = "energy";
      
      private const const_1820:String = "nutrition";
      ...
      {
         if(this.var_50 == null || this.var_199 == null || this.var_63 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_199.width,this.var_63.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_199.width < this.var_63.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1826,param1.level,param1.levelMax);
         ...
         this.updateStateElement(this.const_1820,param1.nutrition,param1.nutritionMax);
         ...
         this.var_1228.remove(param1.id);
         this.var_1228.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1822,this.const_1825,false);
         ...
         _loc5_.fillRect(_loc6_,this.const_1819);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1228.getValue(this.var_518) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_177 && this.var_177.getPetId() == this.var_518)
               {
