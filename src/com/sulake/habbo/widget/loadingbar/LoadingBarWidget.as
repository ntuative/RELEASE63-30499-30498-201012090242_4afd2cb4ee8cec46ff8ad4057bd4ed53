package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_462:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_462.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_462 = null;
         }
         if(this.var_38 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_462 == null)
         {
            this.var_462 = new Sprite();
            this.var_462.addChild(new Bitmap(this.var_38));
            this.var_462.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_462.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_38;
            }
         }
         _loc2_.setDisplayObject(this.var_462);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1162 != "")
         {
            HabboWebTools.openWebPage(this.var_1162);
         }
      }
   }
}
