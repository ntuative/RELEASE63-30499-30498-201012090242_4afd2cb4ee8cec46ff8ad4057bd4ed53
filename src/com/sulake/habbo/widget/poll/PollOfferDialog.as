package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1320:String = "POLL_OFFER_STATE_OK";
      
      public static const const_710:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_465:String = "POLL_OFFER_STATE_UNKNOWN";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  ...
                  case "poll_offer_button_cancel":
                     ...
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_466,this._id));
