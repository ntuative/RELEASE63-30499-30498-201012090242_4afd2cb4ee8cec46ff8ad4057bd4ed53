package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_866:int = 16;
      
      private static const const_1227:int = 40;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_2504 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this._chatModeIdSpeak = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_891 = new Timer(1000,1);
         this.var_891.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_1115 = new Timer(5000,1);
         this.var_1115.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
         this.refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_151,this.windowKeyEventProcessor);
         ...
         this._window.addEventListener(WindowEvent.const_371,this.onWindowMoved);
         this.var_1778 = true;
         this.var_475 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2503 = _loc2_.width + const_866 + _loc6_.width + const_1228;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1227,_loc8_.width) + const_866);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_483 = param1 - this.var_2503;
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_475.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_475 = _loc2_.text;
            if(!this.var_890)
            {
               this.var_890 = true;
               this.var_891.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_890);
