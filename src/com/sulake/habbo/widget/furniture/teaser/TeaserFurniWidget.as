package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1550:int = 3;
      ...
      private const const_1549:String = "xmas10_dialog_telepair_png";
      
      private const const_1161:String = "xmas10_present_dialog_img_png";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_469,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_469,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_469:
         ...
         if(this.var_1239 != _loc2_ && this._window)
         {
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         HabboWebTools.facebookViralGiftPost(_loc2_,_loc3_,this.var_1240);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_150);
            _loc2_.objectId = this.var_314;
            messageListener.processWidgetMessage(_loc2_);
         }
         this.hideInterface();
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = null) : void
      {
         var _loc4_:* = null;
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_579,"ViralGift",param1,param2,param3);
