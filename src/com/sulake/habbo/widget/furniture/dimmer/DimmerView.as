package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_550:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_56,HabboWindowStyle.const_34,0 | 0,new Rectangle(const_1132,const_1133,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_550 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1274 = _loc2_.light;
         if(this.var_376 != null)
         {
            this.var_376.setValue(this.var_1274);
         }
         this.var_479 = this.colors.indexOf(_loc2_.color);
         if(this.var_550 != null)
         {
            this.var_550.setSelectedColorIndex(this.var_479);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1275 = XML(_loc1_.content);
         return this.var_1275;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_550 != null)
         {
            this.var_550.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
