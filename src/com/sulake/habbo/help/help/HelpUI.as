package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201012090237));
         this._toolbar = param5;
         this.var_92 = new Map();
         this.var_92.add(HabboHelpViewEnum.const_1384,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_189,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_425,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_92.add(HabboHelpViewEnum.const_247,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_624,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_367,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_756,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_235,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_92.add(HabboHelpViewEnum.const_973,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_92.add(HabboHelpViewEnum.const_1072,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_718,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_454.length == 0 || param1 != this.var_312)
            {
               this.var_454.push(this.var_312);
            }
         }
         this.var_312 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_235:
               ...
               break;
            case CallForHelpResultEnum.const_917:
               this.showUI(HabboHelpViewEnum.const_1072);
               break;
            case CallForHelpResultEnum.const_1085:
               this.showUI(HabboHelpViewEnum.const_973);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_92.getValue(HabboHelpViewEnum.const_189) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_532));
      }
      ...
      {
         return this.var_92.getValue(this.var_312);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1615 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1614;
         this._window.width = _loc1_.width + this.var_1615;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_454.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_312 == HabboHelpViewEnum.const_189)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_312 == HabboHelpViewEnum.const_189 || this.var_454.length == 0)
         {
            return;
         }
         if(this.var_311 == null)
