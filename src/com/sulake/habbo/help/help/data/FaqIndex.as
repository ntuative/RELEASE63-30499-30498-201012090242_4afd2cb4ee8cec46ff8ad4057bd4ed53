package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         this.var_713 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_714 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_712 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_713.hasItem(param1))
         {
            this.var_713.getItem(param1).answerText = param2;
         }
         if(this.var_714.hasItem(param1))
         {
            this.var_714.getItem(param1).answerText = param2;
         }
         if(this.var_712.hasItem(param1))
         {
            this.var_712.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_713.hasItem(param1))
         {
            return this.var_713.getItem(param1);
         }
         if(this.var_714.hasItem(param1))
         {
         ...
         if(this.var_712.hasItem(param1))
         {
            return this.var_712.getItem(param1);
         }
         var _loc2_:int = 0;
