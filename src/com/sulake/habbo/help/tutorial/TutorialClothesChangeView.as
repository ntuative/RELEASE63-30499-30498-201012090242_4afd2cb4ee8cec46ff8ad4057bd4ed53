package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_44.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_49,this.onShowMenuEvent);
      ...
      public function dispose() : void
      {
         ...
         this.var_44.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_49,this.onShowMenuEvent);
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_49)
         {
            ...
            this.var_44.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_404));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_44.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.MEMENU_ARROW,this.var_650));
      }
