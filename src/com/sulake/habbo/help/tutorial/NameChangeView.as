package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1293:uint = 13232628;
      
      private static var var_1607:uint = 11129827;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1606 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_673)
         {
            this.var_673 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_673)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_920 || param1 == ChangeUserNameResultMessageEvent.var_919)
         {
