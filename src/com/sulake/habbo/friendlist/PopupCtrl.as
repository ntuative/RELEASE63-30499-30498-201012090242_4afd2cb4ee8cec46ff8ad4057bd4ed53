package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_375 = new Timer(500,1);
         this.var_308 = new Timer(100,1);
         super();
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(this.var_49 == null)
         {
            this.var_49 = IWindowContainer(this._friendList.getXmlWindow(this.var_1284));
         ...
         this.var_49.x = _loc4_.x - _loc3_.x + this.var_2234 + param2.width;
