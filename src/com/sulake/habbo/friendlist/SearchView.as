package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         this.var_722 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_722.procedure = this.onSearchInput;
         this.var_722.addEventListener(WindowKeyboardEvent.const_151,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_53.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_377,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_722.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_722.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
