package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private var var_1317:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1317 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_810 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_249 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1317.prepare(this.var_810);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1049,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1038,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_648,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_622,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_648,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_622,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1318 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1318.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1656 == -1 ? 0 : int(this.var_17.height - this.var_1656);
         var _loc4_:int = this.var_1657 == -1 ? 0 : int(this.var_17.width - this.var_1657);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1013,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_648,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1049,false);
         ...
         this.var_1656 = this.var_17.height;
         this.var_1657 = this.var_17.width;
