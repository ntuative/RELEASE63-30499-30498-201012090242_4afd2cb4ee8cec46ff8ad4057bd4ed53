package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_211.length / const_337);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_906 * const_337;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_906 + 1) * const_337,this.var_211.length);
      }
