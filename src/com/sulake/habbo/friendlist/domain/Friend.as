package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1581:int = "F".charCodeAt(0);
      
      public static const const_1764:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_844 = param1.gender;
         this.var_732 = param1.online;
         this.var_1444 = param1.followingAllowed && param1.online;
         this.var_562 = param1.figure;
         this.var_1611 = param1.motto;
         this.var_1609 = param1.lastAccess;
         this.var_1220 = param1.categoryId;
