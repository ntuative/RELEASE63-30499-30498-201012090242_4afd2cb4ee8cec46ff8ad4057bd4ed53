package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1058:IAvatarRenderManager;
      
      private var var_707:ISessionDataManager;
      
      private var var_2427:FriendListLookAndFeel;
      
      private var var_381:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1729:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1058)
         {
            this.var_1058.release(new IIDAvatarRenderManager());
            this.var_1058 = null;
         }
         if(this.var_872)
         {
            this.var_872.release(new IIDHabboNotifications());
            this.var_872 = null;
         }
         if(this._toolbar)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1729 = new OpenedToWebPopup(this);
         }
         this.var_1729.show(x,y);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_271,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1058.createAvatarImage(param1,AvatarScaleType.const_82,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_153.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_153.getKey(param1,param1,param2);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1058 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_872 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_1011,this.getText("friendlist.friends")));
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_318,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_91.addFriend(new Friend(_loc4_));
         }
         this.var_381 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_577)
         {
         ...
         {
            _loc5_ = this.var_91.findCategory(FriendCategory.const_318);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_381.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_381.findTab(FriendListTab.const_91).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_381.findTab(FriendListTab.const_91);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1730.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_381.findTab(FriendListTab.const_91);
         if(!_loc2_)
         {
            return;
         }
