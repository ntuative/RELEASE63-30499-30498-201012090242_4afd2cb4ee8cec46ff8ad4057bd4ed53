package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_643:String = "bg";
      ...
      private var var_2442:IContainerButtonWindow;
      
      private var var_2443:IContainerButtonWindow;
      
      private var var_2444:IContainerButtonWindow;
      ...
      {
         this.var_2445 = this.method_2("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2442 = this.method_2("open_homepage",this.onHomeButtonClick,param1);
         this.var_2443 = this.method_2("room_invite",this.onInviteButtonClick,param1);
         this.var_2444 = this.method_2("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_643);
      ...
      public function refreshCategoryEntry(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.findChildByName(const_643);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2445,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2442,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2443,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2444,this.isEnableRemoveButton(_loc1_));
      }
