package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1536:String = "no_reqs_info";
      ...
      {
         this.var_1458 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1457 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1457.procedure = this.onDismissAllButtonClick;
         this.var_1458.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1096)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_374 && _loc4_.state != FriendRequest.const_314)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1458,_loc1_);
         this.setEnabled(this.var_1457,_loc1_);
      }
