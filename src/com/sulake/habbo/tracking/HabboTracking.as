package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_832:uint = 11;
      ...
      private var var_971:IHabboWindowManager;
      ...
      private var var_523:FramerateTracker = null;
      
      private var var_224:LatencyTracker = null;
      
      private var var_524:LagWarningLogger = null;
      
      private var var_522:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_223 = new PerformanceTracker();
         this.var_523 = new FramerateTracker();
         this.var_224 = new LatencyTracker();
         this.var_524 = new LagWarningLogger();
         this.var_522 = new ToolbarClickTracker(this);
         this.var_1216 = new Array(const_832);
         var _loc4_:int = 0;
         while(_loc4_ < const_832)
         {
            this.var_1216[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1473,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1416,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1433,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_695,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_892,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_971)
            {
               this.var_971.release(new IIDHabboWindowManager());
               this.var_971 = null;
            }
            if(this.var_277)
            {
            ...
            if(this.var_176)
            {
               if(!this.var_176.disposed)
               {
                  ...
                  Component(this.var_176).events.removeEventListener(HabboFriendListTrackingEvent.const_330,this.onFriendlistTrackingEvent);
               }
      ...
      {
         this.var_1216[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_153 = IHabboConfigurationManager(param2);
         if(this.var_153)
         {
            if(this.var_224 != null)
            {
               this.var_224.configuration = this.var_153;
            }
            if(this.var_223 != null)
            {
               this.var_223.configuration = this.var_153;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1382);
            if(this.var_153)
            {
               if(this.var_524 != null)
               {
                  this.var_524.configure(this.var_153);
               }
               if(this.var_523 != null)
               {
                  this.var_523.configure(this.var_153);
               }
               if(this.var_522 != null)
               {
                  this.var_522.configure(this.var_153);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_144);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_668,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_163,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_485,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_223 != null)
            {
               this.var_223.connection = param1;
            }
            if(this.var_224 != null)
            {
               this.var_224.communication = this._communication;
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_625)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1475);
         }
         else if(param1.type == HabboHotelViewEvent.const_485)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1427);
         }
         else if(param1.type == HabboHotelViewEvent.const_65)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1267);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_668:
               this.trackLoginStep(HabboLoginTrackingStep.const_1295,String(this._communication.port));
               break;
      ...
      {
         this.var_971 = IHabboWindowManager(param2);
         if(this.var_971)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_153)
            {
               if(this.var_153.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_153.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1216)
                  {
                  ...
                  if(this.var_223 != null)
                  {
                     _loc4_["null"] = this.var_223.flashVersion;
                     _loc4_["null"] = this.var_223.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_906);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_906,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_176).events.addEventListener(HabboFriendListTrackingEvent.const_330,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_892,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_695,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_266,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_277 = param2 as IAdManager;
         this.var_277.events.addEventListener(AdEvent.const_482,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_522)
         {
            this.var_522.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_153 != null && !Boolean(this.var_153.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_972 > -1 && _loc2_ < this.var_972)
         {
            ++this.var_1483;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1483);
         }
         if(this.var_972 > -1 && _loc2_ - this.var_972 > 15000)
         {
            ++this.var_1482;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1482);
         }
         this.var_972 = _loc2_;
         if(this.var_223 != null)
         {
            this.var_223.update(param1);
         }
         if(this.var_224 != null)
         {
            this.var_224.update(param1);
         }
         if(this.var_523 != null)
         {
            this.var_523.trackUpdate(param1,this);
         }
         if(this.var_524 != null)
         {
            this.var_524.update();
