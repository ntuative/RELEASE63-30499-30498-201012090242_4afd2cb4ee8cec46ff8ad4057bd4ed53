package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class ConditionTypes implements ElementTypeHolder
   {
      ...
      public function ConditionTypes()
      {
         ...
         super();
         this.var_363.push(new ActorIsOnFurni());
         this.var_363.push(new FurnisHaveAvatars());
         this.var_363.push(new StatesMatch());
         this.var_363.push(new TimeElapsedMore());
         this.var_363.push(new TimeElapsedLess());
      }
