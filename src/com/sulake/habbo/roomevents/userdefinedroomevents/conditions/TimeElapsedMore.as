package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class TimeElapsedMore implements ConditionType
   {
      ...
      private var var_1030:SliderWindowController;
      ...
      {
         return ConditionCodes.var_1849;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         var _loc3_:int = this.var_1030.getValue();
      ...
      {
         this.var_87 = param2;
         this.var_1030 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,1200,1);
         this.var_1030.setValue(1);
         this.var_1030.addEventListener(Event.CHANGE,this.onSliderChange);
      }
      
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         var _loc3_:int = param2.intParams[0] - 1;
         this.var_1030.setValue(_loc3_);
      }
