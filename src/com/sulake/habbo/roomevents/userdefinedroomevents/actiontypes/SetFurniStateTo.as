package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class SetFurniStateTo implements ActionType
   {
      ...
      {
         return ActionTypeCodes.var_1857;
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.select(this.method_3(param1),param2.getBoolean(1));
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.getIntState(this.method_3(param1)));
      ...
      private function method_3(param1:IWindowContainer) : ICheckBoxWindow
      {
