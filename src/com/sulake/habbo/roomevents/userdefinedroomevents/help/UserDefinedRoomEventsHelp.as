package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1009:IContainerButtonWindow;
      
      private var var_1010:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1566 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1010 = this.var_1566.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1010)
         {
            this.var_1010.procedure = this.onButtonClick;
         }
         this.var_1009 = this.var_1566.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1009)
         {
            this.var_1009.procedure = this.onButtonClick;
         }
      ...
      private function checkButtons() : void
      {
         ...
         {
            this.var_1009.disable();
         }
         else
         {
            this.var_1009.enable();
         }
         if(this.var_231 <= 0)
         {
            this.var_1010.disable();
         }
         else
         {
            this.var_1010.enable();
         }
      }
