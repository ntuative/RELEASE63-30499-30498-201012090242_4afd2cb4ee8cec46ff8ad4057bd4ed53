package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         this.var_1144 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(this.var_1144 != null)
         {
            this.var_1144.addEventListener(WindowKeyboardEvent.const_631,this.onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(this.var_1144.text));
      }
   }
}
