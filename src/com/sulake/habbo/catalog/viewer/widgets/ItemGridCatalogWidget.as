   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_633,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_298,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_657,this.deActivateScrollbar);
      ...
      override public function dispose() : void
      {
         ...
         this.var_1152.destroyGridItems();
         this.var_1152 = null;
         this.var_1693 = null;
         this.var_323 = null;
         super.dispose();
      ...
      {
         this.var_1152 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_770 == page.offers.length)
            {
         ...
         while(_loc3_ < 3)
         {
            if(this.var_770 >= 0 && this.var_770 < page.offers.length)
            {
               _loc4_ = page.offers[this.var_770];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_512)
         {
            ++this.var_1440;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1440);
         }
      }
