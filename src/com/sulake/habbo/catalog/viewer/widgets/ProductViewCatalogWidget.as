package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : void
      {
         ...
         this.var_1132 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1820 = new Point(this.var_84.x,this.var_84.y);
         this.var_490 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1385 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1821 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1132.text = _loc5_;
         this.var_909.height = this.var_909.textHeight + 5;
         this.var_1132.y = this.var_909.y + this.var_909.height;
         this.var_1132.height = Math.max(130,this.var_1132.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_512:
                  _loc6_ = this.var_1821.clone();
                  if(this.var_490 != null)
                  {
                     this.var_490.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_490,this.var_1385,this.var_1693);
                     ...
                     case ProductTypeEnum.const_242:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_280,AvatarAction.const_430);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2552)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2552 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_84 != null && true)
         {
            ...
            this.var_84.x = this.var_1820.x;
            this.var_84.y = this.var_1820.y;
            if(param3 != null)
            {
