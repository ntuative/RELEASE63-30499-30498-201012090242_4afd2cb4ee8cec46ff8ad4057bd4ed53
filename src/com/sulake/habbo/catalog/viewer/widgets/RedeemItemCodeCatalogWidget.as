package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1064.removeEventListener(WindowKeyboardEvent.const_151,this.windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(this.var_1064 != null)
         {
            this.var_1064.addEventListener(WindowKeyboardEvent.const_151,this.windowKeyEventProcessor);
         }
      }
