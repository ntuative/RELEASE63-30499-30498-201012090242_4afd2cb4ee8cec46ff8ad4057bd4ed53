package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_1214:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_429)
         {
            this.var_429.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_429 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_519)
         {
            ...
            this.var_519 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_519)
         {
            return;
         ...
         if(!this.var_429)
         {
            this.var_429 = new Timer(25);
            this.var_429.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_964 = 0;
         this.populateList();
         this.var_429.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_964 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_964));
            ++this.var_964;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_519 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_519.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1538);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1214.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_58)
