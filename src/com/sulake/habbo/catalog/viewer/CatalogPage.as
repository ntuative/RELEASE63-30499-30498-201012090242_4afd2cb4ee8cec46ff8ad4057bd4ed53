package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1530:String = "ctlg_";
       
      
      protected var var_1881:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1078:ICatalogViewer;
      ...
      private var var_1390:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1389:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1390 = new EventDispatcher();
      ...
      {
         var _loc2_:String = const_1530 + param1;
         ...
         this.var_1881 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1881) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_1389 = new ItemGridCatalogWidget(_loc1_);
            this.var_58.push(this.var_1389);
         }
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1281) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1430) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1440) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1390;
            _loc2_.init();
         }
         this.var_1390.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1390.dispatchEvent(param1);
      }
   }
}
