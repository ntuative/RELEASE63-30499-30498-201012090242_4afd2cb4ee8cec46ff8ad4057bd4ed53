package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1844:uint = 4.291613146E9;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_76:
                  ...
                  break;
               case ProductTypeEnum.const_242:
      ...
      private function updateLocalizations() : void
      {
         ...
         var _loc8_:String = this.var_83.activityPointType == Purse.const_530 ? "pixels" : "activitypoints";
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1700 = _loc1_.stuffTypes;
            this.var_725 = _loc1_.boxTypes;
            this.var_726 = _loc1_.ribbonTypes;
            this.var_1120 = this.var_1700[0];
            this.var_338 = this.var_725[0];
            this.var_337 = this.var_726[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_337 < 0)
         {
            this.var_337 = this.var_726.length - 1;
         }
         if(this.var_337 > this.var_726.length - 1)
         {
            this.var_337 = 0;
         }
         if(this.var_338 < 0)
         {
            this.var_338 = this.var_725.length - 1;
         }
         if(this.var_338 > this.var_725.length - 1)
         {
            this.var_338 = 0;
         }
         var _loc1_:int = this.var_725[this.var_338] * 1000 + this.var_726[this.var_337];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_83.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1120,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1373 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1700;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1120);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_725[this.var_338]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_726[this.var_337]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_83,this.var_1374,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_83.offerId,this.var_1374);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_109:
               ...
               for each(_loc7_ in this.var_211)
               {
                  ...
                  if(_loc5_.length >= this.const_1843)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2538 = _loc3_.text;
               break;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1120;
               }
            }
            _loc4_++;
         }
