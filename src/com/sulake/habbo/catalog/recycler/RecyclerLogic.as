package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_838:int = 0;
      
      private static const const_386:int = 1;
      
      private static const const_837:int = 2;
      ...
      {
         return this.var_535 != const_838;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1545 != RecyclerStatusMessageEvent.const_1105;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_535 == const_386;
      }
      ...
      {
         this.var_535 = const_837;
         this.var_105 = new Array(const_184);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1293:
               this.var_535 = const_386;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1105:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_968:
               if(this._view != null)
               {
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_105.length > 0)
         {
            oldObjectData = this.var_105[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_184)
            {
               oldObjectData = this.var_105[newSlotId];
         ...
         this.var_105[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_105[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_105[param1].id))
         {
            return;
         }
         this.var_105[param1] = null;
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_105.length)
         {
            _loc3_ = this.var_105[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_105.length < const_184)
         {
            return false;
         }
         var _loc1_:int = 0;
