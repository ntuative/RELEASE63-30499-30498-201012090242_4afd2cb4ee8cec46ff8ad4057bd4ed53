package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2672:String = "magic.credits";
      
      private var var_2635:String = "magic.pixels";
      
      private var var_2634:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2635);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2634,true);
      }
