package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1192:XML;
      
      private static var var_1191:XML;
      ...
      {
         this.var_53 = navigator.catalog.windowManager.buildFromXML(var_1191) as IItemListWindow;
         if(this.var_53 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1192) as IWindowContainer;
         }
         else
         {
