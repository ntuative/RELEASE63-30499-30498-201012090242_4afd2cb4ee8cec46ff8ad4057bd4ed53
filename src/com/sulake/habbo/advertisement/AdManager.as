package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2160 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2161 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2159 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1558 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1558 > 0 && this.var_1556 >= this.var_1558)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1000;
         if(_loc1_ > this.var_2161)
         {
            ++this.var_1556;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(this.var_1250 != "")
         {
            ...
            {
               this.var_193 = new Timer(this.var_2159,1);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_471,0,0,param1.bitmapData,this.var_2162));
            this.var_1000 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_393));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1251 = _loc2_.imageUrl;
         this.var_1557 = _loc2_.clickUrl;
         if(this.var_1251 != "" && this.var_1557 != "")
         {
            _loc3_ = this.var_1251;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1251);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_482,0,0,_loc4_,this.var_1557,this.var_998,this.var_999));
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_999 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
