package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return this.var_1306.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2303.elements("menu");
         var _loc5_:int = 0;
      ...
      private function alignItems() : void
      {
         ...
         {
            _loc2_ = this.var_679.indexOf(this.var_1305[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_273[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1086 + _loc3_);
                  _loc3_ += this.var_1304;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_273[this.var_679.indexOf(param1)];
      }
