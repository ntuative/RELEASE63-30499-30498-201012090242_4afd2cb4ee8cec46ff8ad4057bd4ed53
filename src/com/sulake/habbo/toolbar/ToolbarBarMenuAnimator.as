package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_872:int = 50;
      
      private static const const_1234:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1379:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_728 = new Timer(const_1142);
         this.var_728.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_340[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_872 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_872 || param1.desktop.height - param1.y < const_1234;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1379.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_340.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1379.getIconLoc(param1.iconId);
      ...
      {
         return this.var_602[this.var_601.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_601[this.var_602.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_601.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_601.splice(_loc3_,1);
            this.var_602.splice(_loc3_,1);
         }
         this.var_602.push(param1.name);
         this.var_601.push(param2);
         param1.addEventListener(WindowEvent.const_371,this.windowEventListener);
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_340.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_340.splice(this.var_340.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_602[_loc2_] == param1.window.name)
            {
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_340.length)
         {
            _loc2_ = this._itemList[this.var_340[_loc7_]];
            if(_loc2_.active)
            {
