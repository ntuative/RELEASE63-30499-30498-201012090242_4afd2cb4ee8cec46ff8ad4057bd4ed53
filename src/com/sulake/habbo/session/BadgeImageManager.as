package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_954:String = "group_badge";
      
      public static const const_1499:String = "normal_badge";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1499:
               ...
               {
                  _loc5_ = this.var_153.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_954:
               if(this.var_153 != null)
               {
                  if(this.var_153 != null)
                  {
                     _loc5_ = this.var_153.getKey("group.badge.url");
