package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1816:int = 2500;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_975 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_975.connection = param1;
         }
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1218));
         this.var_1219.add(this.var_1218,getTimer());
         ++this.var_1218;
      }
      
      public function receivedChatWithTrackingId(param1:int) : void
      {
         var _loc2_:Object = this.var_1219.remove(param1);
         if(_loc2_ != null)
         {
            if(getTimer() - int(_loc2_) > this.const_1816)
            {
      ...
      {
         return this.var_975 as IUserDataManager;
      }
