package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1171:String = "Default";
      
      private static const const_1169:int = 2;
      
      private static const const_1170:String = AvatarSetType.const_32;
      ...
      protected var var_562:AvatarFigureContainer;
      
      protected var var_501:IAvatarDataContainer;
      ...
      private var var_2189:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1170,const_1169);
         this.var_287 = new Array();
         this.var_918 = new ActiveActionData(AvatarAction.const_315);
         this.var_918.definition = this._structure.getActionDefinition(const_1171);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_621)
         {
            ...
            if(this.var_660)
            {
               for each(_loc2_ in this.var_660)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_562,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1569;
         if(param2 < AvatarDirectionAngle.const_947)
         {
            param2 = AvatarDirectionAngle.const_301 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_301)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.method_5(param1.animation.id,this.var_537,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_266.length == 1 && this.var_85 == this.var_1862)
         {
            return this.var_85 + this.var_447 + this.var_537 % 4;
         }
         if(this.var_266.length == 2)
         {
            for each(_loc1_ in this.var_266)
            {
               ...
               {
                  return this.var_85 + this.var_447 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_537 % 11;
                  return this.var_85 + "_" + this.var_1862 + this.var_447 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2191 || param2 != this.var_2189 || param1 != this.var_2190)
         {
            this.var_2191 = param3;
            this.var_2189 = param2;
            this.var_2190 = param1;
            this.var_1568 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1156 || this.var_38 == null || (this.var_38.width != _loc5_.width || this.var_38.height != _loc5_.height))
         {
            if(this.var_38 != null && !this.var_1156)
            {
               this.var_38.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_537);
         ...
         {
            if(this.var_501.paletteIsGrayscale)
            {
               ...
               this.var_38 = _loc13_;
               this.var_38.paletteMap(this.var_38,this.var_38.rect,new Point(0,0),this.var_501.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_537);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_287.push(new ActiveActionData(param1,param2,this.var_537));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_254 = this.var_918;
         this.var_254.definition = this.var_918.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_447 = "";
         this.var_266 = this._structure.sortActions(this.var_287);
         if(this.var_266 == null)
         {
         ...
         {
            this.var_666 = this._structure.getCanvasOffsets(this.var_266,this._scale,this.var_85);
            for each(_loc4_ in this.var_266)
            {
               this.var_447 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_284)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1257 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1257 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1259 != this.var_447)
            {
               _loc1_ = true;
               this.var_1259 = this.var_447;
            }
         }
         this.var_1258 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_266)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_789 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1569 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_501 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_299 || _loc1_.actionType == AvatarAction.const_212 || _loc1_.actionType == AvatarAction.const_373)
               {
                  this.var_789 = true;
               }
            }
