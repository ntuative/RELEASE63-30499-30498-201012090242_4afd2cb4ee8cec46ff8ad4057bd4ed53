package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_1849:int = 2;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_233)
         {
            for each(_loc2_ in this.var_233 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_196 = new Array(param1.length);
         var _loc3_:int = 0;
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_196[param2],param2);
         this.var_196[param2] = param1;
      ...
      public function getSelectedColorIds() : Array
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(!this.var_196 || this.var_196.length == 0)
         {
            return null;
         }
         ...
         var _loc1_:Array = this.var_233[0] as Array;
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.var_196.length)
         {
            _loc7_ = this.var_233[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > this.var_196[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_196[_loc5_]] as AvatarEditorGridColorItem;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_196[param1])
         {
            return null;
         }
         return _loc2_[this.var_196[param1]] as AvatarEditorGridColorItem;
      }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_233.length <= param1)
         {
            return null;
         }
         return this.var_233[param1] as Array;
      }
