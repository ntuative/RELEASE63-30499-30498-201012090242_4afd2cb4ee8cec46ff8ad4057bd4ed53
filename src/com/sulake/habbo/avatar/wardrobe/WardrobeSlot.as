package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_562 && this.var_1308)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_82,this.var_844,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_32,parseInt(FigureData.const_608));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1308 && this.var_562 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_562 = this._controller.figureData.getFigureString();
               this.var_844 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1648,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_562)
               {
                  this._controller.loadAvatarInEditor(this.var_562,this.var_844,this._controller.clubMemberLevel);
               }
         }
      }
