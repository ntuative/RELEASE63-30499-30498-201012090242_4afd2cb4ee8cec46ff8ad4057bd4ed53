package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1720 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2415 = parseInt(_loc2_,16);
         this.var_2414 = parseInt(_loc3_,16);
         ...
         this.var_1746 = new ColorTransform(this.var_1520,this.var_1517,this.var_1521,this._alphaMultiplier);
         this.var_1088 = this.generatePaletteMapForGrayscale(this.var_2414,this.var_2415);
      }
