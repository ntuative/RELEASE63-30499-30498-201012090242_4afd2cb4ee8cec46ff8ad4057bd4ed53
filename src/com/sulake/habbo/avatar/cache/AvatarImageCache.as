package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1552:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1221:IAvatarImage;
      ...
      private var var_536:AvatarCanvas;
      
      private var _disposed:Boolean;
      
      private var _bodyPartCache:AvatarImageBodyPartCache;
      
      private var var_300:IActiveActionData;
      
      private var var_391:AvatarImageBodyPartContainer;
      
      private var var_1242:String;
      
      private var var_106:AvatarImagePartContainer;
      
      private var var_2130:Point;
      ...
      private var var_371:BitmapDataAsset;
      
      private var var_798:BitmapData;
      
      private var var_2131:ByteArray;
      
      private var var_2132:ImageData;
      
      private var var_1547:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_652 == GeometryType.const_1048 && param1 == GeometryType.const_941 || this.var_652 == GeometryType.const_941 && param1 == GeometryType.const_1048)
         {
            this.var_652 = param1;
            this.var_536 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_300 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_300;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_300 || !this.var_300.definition))
         {
            if(this.var_300.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_300.definition.state + "." + this.var_300.actionParameter);
               _loc13_ = param2 - this.var_300.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_300.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_300 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_569)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1221.getFigure(),_loc5_,this.var_652,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_391 = _loc10_.getImageContainer(_loc4_);
         if(this.var_391 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_391 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_300);
            if(this.var_391 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_391,_loc4_);
         }
         this.var_391.offset = _loc8_;
         return this.var_391;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_536)
         {
            this.var_536 = this._structure.getCanvas(this._scale,this.var_652);
            if(!this.var_536)
            {
               return null;
            }
            this.var_2130 = new Point(0,this.var_536.height - int(this.var_536.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1259[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_796 || _loc10_ == AvatarAction.const_373;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1242 = this.var_106.method_13;
               this.var_155 = this.var_106.partType;
               this.var_1546 = this.var_106.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_106.flippedPartType != this.var_155)
                     {
                        this.var_155 = this.var_106.flippedPartType;
                     }
                  }
               }
               this.var_1241 = this._scale + "_" + this.var_106.action.assetPartDefinition + "_" + this.var_155 + "_" + this.var_1546 + "_" + _loc5_ + "_" + this._frame;
               this.var_371 = this._assets.getAssetByName(this.var_1241) as BitmapDataAsset;
               if(this.var_371 == null)
               {
                  this.var_1241 = this._scale + "_std_" + this.var_155 + "_" + this.var_1546 + "_" + _loc5_ + "_0";
                  this.var_371 = this._assets.getAssetByName(this.var_1241) as BitmapDataAsset;
               }
               if(!(!this.var_371 || !this.var_371.content))
               {
                  if(this.var_106.paletteMapId > -1)
                  {
                     this.var_1547 = this._structure.renderManager.paletteManager.getPalette(this.var_106.paletteMapId);
                     if(this.var_1547 != null)
                     {
                        this.var_798 = this.var_371.content as BitmapData;
                        this.var_154 = new BitmapData(this.var_798.width,this.var_798.height);
                        this.var_2131 = this.var_1547.colorize(this.var_798.getPixels(this.var_798.rect));
                        this.var_154.setPixels(this.var_154.rect,this.var_2131);
                     }
                     else
                     {
                        this.var_154 = (this.var_371.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1242 == AvatarBodyPartType.const_214 || this.var_1242 == AvatarBodyPartType.const_1417 || this.var_1242 == AvatarBodyPartType.const_1482) && this.var_106.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_154.colorTransform(this.var_154.rect,this.var_106.color.colorTransform);
                  }
                  if(this.var_106.isBlendable)
                  {
                     this.var_154.colorTransform(this.var_154.rect,this.var_106.blendTransform);
                  }
                  this.var_800 = this.var_371.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_47)
                     {
                  ...
                  this.var_2132 = new ImageData(this.var_154,this.var_800,_loc7_);
                  this.var_799.push(this.var_2132);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_799,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2130.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_47)
            {
         ...
         _loc8_ = this.var_799.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_799.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
