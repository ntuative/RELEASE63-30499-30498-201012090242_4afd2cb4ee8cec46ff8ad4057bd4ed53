package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1128:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1127:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_934:AvatarEditorHandler;
      ...
      private var var_763:IFigureData;
      ...
      private function init() : void
      {
         ...
         if(!this.var_173)
         {
            ...
            this.var_513["null"] = new FigureData(this);
            this.var_513["null"] = new FigureData(this);
            _loc1_ = this.var_513["null"];
            _loc2_ = this.var_513["null"];
            _loc1_.loadAvatarData(const_1128,FigureData.const_71);
            _loc2_.loadAvatarData(const_1127,FigureData.FEMALE);
            this.var_91 = new Map();
            this.var_419 = new Map();
            this.var_91.add(AvatarEditorFigureCategory.const_779,new BodyModel(this));
            ...
            this.var_91.add(AvatarEditorFigureCategory.const_809,new LegsModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_958,new HotLooksModel(this));
            this.var_419.add(AvatarEditorSideCategory.const_98,new WardrobeModel(this));
            this.var_419.add(AvatarEditorSideCategory.const_509,new ClubPromoModel(this));
            this.var_173 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         this.var_935 = param3;
         var _loc4_:FigureData = this.var_513[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_763.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_763.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_779);
         }
      ...
      {
         this.var_763 = this.var_418.getFigureData(AvatarType.const_106);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_934 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_513[this.var_844];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1174 != null)
         {
            ...
            this.var_1174.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1420;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_935 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1129)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1402.clone() as IWindowContainer,param1,_loc13_);
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1148.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1254)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_935 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1148.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_935 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_419.getValue(AvatarEditorSideCategory.const_98);
      }
