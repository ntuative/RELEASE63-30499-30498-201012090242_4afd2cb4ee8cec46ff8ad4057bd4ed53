package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2213 = parseInt(param1.@precedence);
         this.var_2214 = String(param1.@activepartset);
         this.var_2217 = String(param1.@assetpartdefinition);
         this.var_2218 = String(param1.@lay);
         this.var_652 = String(param1.@geometrytype);
         this.var_2181 = Boolean(parseInt(param1.@main));
         this.var_2215 = Boolean(parseInt(param1.@method_4));
         this.var_2219 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            {
               this.var_1587[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_363[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1587[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2216;
         }
         return _loc2_;
      }
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_363[param1];
         if(_loc2_ != null)
         {
