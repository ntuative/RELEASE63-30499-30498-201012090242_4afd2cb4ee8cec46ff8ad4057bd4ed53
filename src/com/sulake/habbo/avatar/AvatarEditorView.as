package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1148:IWindowContainer;
      
      public static var var_1402:IWindowContainer;
      
      public static var var_1856:int = 6710886;
      ...
      private var var_440:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_439:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_987 = [];
         this.var_1237 = [AvatarEditorFigureCategory.const_779,AvatarEditorFigureCategory.const_42,AvatarEditorFigureCategory.const_214,AvatarEditorFigureCategory.const_809,AvatarEditorFigureCategory.const_958,AvatarEditorFigureCategory.const_98];
         super();
         ...
         if(var_1148 == null)
         {
            ...
            var_1148 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1402 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1402 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_370 = new Timer(1000);
         this.var_370.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1237;
         }
         for each(_loc6_ in param4)
         {
            this.var_987.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_370.stop();
            this.var_370.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_370 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1237);
         }
         if(param1.length != this.var_987.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_987.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2119 = this.canChangeOutfit();
            this.var_370.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_440 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_440.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_440.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_987.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_440.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_440.numSelectables)
               {
                  this.var_440.getSelectableAt(_loc6_).x = this.var_440.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1237;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1544 == AvatarEditorSideCategory.const_98 || this.var_2121))
         {
      ...
      {
         if(this.var_1544 == AvatarEditorSideCategory.const_98)
         {
            this.var_2121 = false;
            this.setSideContent(AvatarEditorSideCategory.const_782);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_782:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_312 = param1;
         this.var_440.setSelected(this.var_440.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_439)
         {
            ...
            this.var_439 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_439.procedure = this.stripClubDialogEventProc;
            this.var_439.center();
         }
         else
         {
