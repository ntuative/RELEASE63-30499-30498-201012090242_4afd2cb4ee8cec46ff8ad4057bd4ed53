package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1629:int = 255;
      
      private var var_1300:uint = 16777215;
      
      private var var_1628:int = 255;
      
      private var var_1047:uint = 16777215;
      
      private var var_1627:int = 255;
      
      private var var_1046:int = 0;
      
      private var var_1626:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_981,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_686,16777215);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1046)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1629;
            if(_loc2_ - this.var_1046 >= this.var_1626)
            {
               _loc3_ = this.var_1047;
               _loc4_ = this.var_1627;
               this.var_1046 = 0;
            }
            else
            {
               _loc7_ = this.var_1300 >> 16 & 255;
               _loc8_ = this.var_1300 >> 8 & 255;
               _loc9_ = this.var_1300 & 255;
               _loc10_ = this.var_1047 >> 16 & 255;
               _loc11_ = this.var_1047 >> 8 & 255;
               _loc12_ = this.var_1047 & 255;
               _loc13_ = (_loc2_ - this.var_1046) / this.var_1626;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1628 + (this.var_1627 - this.var_1628) * _loc13_;
               this._color = _loc3_;
               this.var_1629 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_686,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_614:
               param2.setString(RoomObjectVariableEnum.const_816,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_514:
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_802:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1090,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_931:
               param2.setNumber(RoomObjectVariableEnum.const_697,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_995:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1300 = this._color;
         this.var_1628 = this.var_1629;
         this.var_1047 = _loc3_;
         this.var_1627 = _loc4_;
         this.var_1046 = getTimer();
         this.var_1626 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1450,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1436,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1410,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_146 || _loc13_ == RoomPlaneData.const_276)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
