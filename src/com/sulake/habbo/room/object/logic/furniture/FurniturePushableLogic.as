package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_851:int = 0;
      
      private static const const_1568:int = 1;
       
      
      private var var_1723:Vector3d = null;
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1723.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1723).length == 0)
            {
               if(object.getState(0) != const_851)
               {
                  object.setState(const_851,0);
               }
            }
         }
      }
