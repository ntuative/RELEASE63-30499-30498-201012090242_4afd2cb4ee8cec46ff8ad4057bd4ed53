package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1593:int = 16777216;
      ...
      private var var_1636:int = 16777216;
      
      private var var_2631:int = 69069;
      
      private var var_2630:int = 5;
      ...
      {
         var _loc1_:int = this.var_2631 * this.var_1637 + this.var_2630;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1636;
         this.var_1637 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1636 * param2);
      }
   }
}
