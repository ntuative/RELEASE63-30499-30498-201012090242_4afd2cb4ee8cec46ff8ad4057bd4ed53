package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1477:int = 16777215;
      
      public static const const_1509:int = 13421772;
      
      private static const const_875:int = 16777215;
      
      private static const const_876:int = 13421772;
      
      private static const const_874:int = 10066329;
      
      private static const const_873:int = 10066329;
      
      public static const const_1461:int = 16777215;
      
      public static const const_1301:int = 13421772;
      
      public static const const_1404:int = 10066329;
      ...
      private var var_1435:String = null;
      
      private var _floorType:String = null;
      
      private var var_1434:String = null;
      ...
      private const const_1846:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_981);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1414)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_113,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1846 && !_loc5_ && !_loc7_)
         {
            return;
         }
            ...
            while(_loc9_ < this.var_343.length)
            {
               ...
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_87)
               {
                  if(this.var_1822)
                  {
                     ...
                     _loc14_ = uint((_loc13_ & 255) * this.var_2553 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2554 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2555 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1645)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1307 || _loc3_.y != this.var_2315 || _loc3_.z != this.var_2313 || param1.scale != this.var_2316))
            {
               this.var_1307 = _loc3_.x;
               this.var_2315 = _loc3_.y;
               this.var_2313 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1090);
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_686));
            if(_loc4_ != this.var_1133)
            {
               this.var_1133 = _loc4_;
               this.var_2553 = this.var_1133 & 255;
               this.var_2554 = this.var_1133 >> 8 & 255;
               this.var_2555 = this.var_1133 >> 16 & 255;
               _loc2_ = true;
            }
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_216 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_816);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_795);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_663);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_697));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_610));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_694));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1684;
      }
         ...
         while(_loc8_ < this.var_491.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_116.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_113 || _loc3_.type == RoomPlane.const_87)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_113 || _loc3_.type == RoomPlane.const_87 && _loc12_ == RoomPlaneBitmapMaskData.const_207)
                              {
