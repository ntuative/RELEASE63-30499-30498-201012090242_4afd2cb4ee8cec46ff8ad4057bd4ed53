package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      {
         this.var_703 = new Vector3d(0,0,0);
      ...
      {
         var _loc3_:Number = this.var_1195 * Math.cos(this.var_1086 + this.var_1705);
         var _loc4_:Number = this.var_1195 * Math.sin(this.var_1086 + this.var_1705);
         var _loc5_:Number = this._height;
         this.var_703.x = (_loc3_ - _loc4_) * (param2 / 2);
         this.var_703.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - this._height * (param2 / 2);
         this.var_703.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            this.var_703.add(param1);
         }
         return this.var_703;
      }
