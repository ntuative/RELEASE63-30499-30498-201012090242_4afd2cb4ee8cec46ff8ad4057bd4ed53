package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_691:String = "RCL_LOADER_READY";
      ...
      private static const const_557:String = "wall_place_holder";
      
      private static const const_1243:String = const_392;
      ...
      private var var_1388:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2558 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2559 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2561 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2562 = param2.getKey("public.room.dynamic.download.url","");
         this.var_2564 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = this.var_390.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_493.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_493.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_738.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_610.add(_loc3_,_loc4_);
               if(this.var_611.indexOf(_loc7_) < 0)
               {
                  this.var_611.push(_loc7_);
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_609.add(_loc3_,_loc4_);
               if(this._wallItems.indexOf(_loc7_) < 0)
               {
                  this._wallItems.push(_loc7_);
               }
            }
            _loc8_ = this.var_608.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_608.remove(_loc7_);
               this.var_608.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2560)
         {
            ...
            {
               this.var_1388.dispatchEvent(new Event(const_691));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_495 != null)
         {
            this.var_495.remove(param2);
            this.var_495.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_495 != null)
         {
            _loc2_ = this.var_495.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_611.indexOf(param1) >= 0)
         {
         ...
         {
            return RoomObjectCategoryEnum.const_267;
         }
         return RoomObjectCategoryEnum.const_157;
      }
      ...
      {
         return [const_392,const_557,ROOM_CONTENT,const_879,const_880];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_610.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_609.getValue(param1) as String;
      ...
      {
         var _loc2_:String = this.var_609.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      {
         if(this.var_185 != null && this.var_185.hasWorldType(const_312 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_160 || param1 == RoomObjectVisualizationEnum.const_61 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_608.getValue(param1));
         }
         return 0;
      }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         switch(param2)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
               this.var_610[param1] = _loc4_;
               break;
            case RoomObjectCategoryEnum.const_27:
               this.var_609[param1] = _loc4_;
               break;
            default:
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
                     if(this.var_611.indexOf(_loc4_) == -1)
                     {
                        this.var_611.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1387.getValue(param1) != null)
         {
            this.var_185 = this.var_1387.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_713,this.onContentLoaded);
            _loc6_ = 0;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1349);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2558.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = this.getVisualizationXML(_loc5_);
               _loc8_ = this.extractPublicRoomFromXML(_loc5_,_loc7_);
               this.var_1387.add(_loc5_,_loc8_);
               this.var_185 = _loc8_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_737.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_737.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_493.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_737.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_493.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_493.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_231 && _loc5_ != RoomObjectLogicEnum.const_160)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_480.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(this.getObjectCategory(const_312 + param1) == RoomObjectCategoryEnum.const_73)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_185.getWorldHeightScale(const_312 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_185 != null)
         {
            return this.var_185.getWorldScale(const_312 + param1);
         }
         return 32;
      }
