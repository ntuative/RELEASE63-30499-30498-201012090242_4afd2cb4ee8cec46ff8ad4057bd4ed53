package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_549:RoomInfoViewCtrl;
      
      private var var_1020:RoomCreateViewCtrl;
      ...
      private var var_2668:Dictionary;
      ...
      private var var_822:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_268 = new MainViewCtrl(this);
         this.var_549 = new RoomInfoViewCtrl(this);
         this.var_1020 = new RoomCreateViewCtrl(this);
         this.var_2228 = new RoomThumbnailRenderer(this);
         this.var_822 = new GuestRoomPasswordInput(this);
         this.var_341 = new GuestRoomDoorbell(this);
         this.var_381 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_271,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_549.registerToolbarEvents();
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_153.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_268.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_268.startSearch(Tabs.const_246,Tabs.const_331,param1);
         this.var_268.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_268.startSearch(Tabs.const_268,Tabs.const_201);
         this.var_381.getTab(Tabs.const_268).tabPageDecorator.tabSelected();
      }
