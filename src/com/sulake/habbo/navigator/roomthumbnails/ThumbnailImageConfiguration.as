package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1780 = this._navigator.getButtonImage(this.var_1781);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1782 == null)
         {
            ...
            this.var_1782 = new Rectangle(this.var_1366,this.var_1366,_loc1_.width - 2 * this.var_1366,_loc1_.height - 2 * this.var_1366);
         }
         this.var_592.bitmap.fillRect(this.var_592.bitmap.rect,4281545523);
         this.var_592.bitmap.fillRect(this.var_1782,4284900966);
         this.copyTo(this.var_592.bitmap);
         if(this.var_175)
         {
            this.var_592.bitmap.copyPixels(this.var_1779,this.var_1779.rect,new Point(0,0),null,null,true);
         }
