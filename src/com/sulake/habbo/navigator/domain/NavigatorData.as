package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private static const const_1573:int = 10;
      ...
      private var var_593:RoomEventData;
      ...
      private var var_896:PublicRoomShortData;
      ...
      public function onRoomEnter(param1:RoomEntryInfoMessageParser) : void
      {
         ...
         {
            this.var_896 = param1.publicSpace;
            this.var_593 = null;
         }
      }
      ...
      {
         return this.var_1369 >= this.var_2523;
      }
