package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_2237:ITextWindow;
      
      private var var_2238:ITextWindow;
      ...
      {
         if(param1 != this.var_309 || this.var_1024 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1455)
         {
         ...
         {
            this.var_1026.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1462)
         {
            this.setTagError(this.var_794,param3,"${navigator.roomsettings.unacceptablewords}");
         ...
         {
            this.setTagError(this.var_794,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         ...
         {
            this.var_822.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_414,this.onDoorModePasswordSelect);
         ...
         this.var_1026 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_794 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_795 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_822 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1027 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1025 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1023 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1021 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_551 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1590 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1277 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1029 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1028 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1589 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1276 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_235 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1022 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2237 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2238 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1588 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1588.procedure = this.onSwitchView;
         this.var_1022.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1590.visible = this._inRoom;
         this.var_1589.visible = this._inRoom;
         this.var_2238.visible = this.var_451;
         this.var_2237.visible = !this.var_451;
         if(this.var_451)
         {
            this.var_1028.visible = true;
            this.var_1276.visible = false;
         ...
         {
            this.populateForm();
            this.var_1029.visible = true;
            this.var_1276.visible = true;
            this.var_1277.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1277.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1029.height = Util.getLowestPoint(this.var_1029) + 4;
         }
         this.var_1588.text = !!this.var_451 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1590.name,this.var_1277.name,this.var_1029.name,this.var_1028.name,this.var_1276.name,this.var_1589.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1026.setText(_loc1_.description);
         this.var_822.setText("");
         ...
         this.setTag(this.var_794,_loc1_.tags[0]);
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1026.getText();
         ...
         {
            _loc8_ = this.var_822.getText();
            _loc9_ = this.var_1027.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_822.clearErrors();
               this.var_1027.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1025.isSelected;
         _loc2_.allowFoodConsume = this.var_1023.isSelected;
         _loc2_.allowWalkThrough = this.var_1021.isSelected;
         _loc2_.hideWalls = this.var_551.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_794,_loc2_.tags);
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_148,HabboToolbarIconEnum.ROOMINFO));
      }
