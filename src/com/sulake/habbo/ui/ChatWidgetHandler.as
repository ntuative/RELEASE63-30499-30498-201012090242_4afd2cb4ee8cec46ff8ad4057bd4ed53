package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_827:Map = null;
      
      private var _connection:IConnection = null;
      
      private var var_1033:Number = 0.0;
      
      private var var_669:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_379 != null)
         {
            ...
            {
               _loc2_ = this.var_379.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_674,RoomWidgetChatSelectAvatarMessage.const_604];
      }
      ...
      {
         return [RoomSessionChatEvent.const_175];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_175:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_379.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_380.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_827.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_211)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_379.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 ...
                                 if(_loc12_ != 0)
                                 {
                                    this.var_827.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1033 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1033);
            }
            if(this.var_669 == null)
            {
               ...
               this.var_452.y = 0;
               this.var_452.z = 0;
               this.var_669 = _loc4_.getScreenPoint(this.var_452);
               this.var_1033 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_452.x = 0;
            this.var_452.y = 0;
            this.var_452.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_452);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_669.x || _loc8_.y != this.var_669.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_669,_loc5_));
