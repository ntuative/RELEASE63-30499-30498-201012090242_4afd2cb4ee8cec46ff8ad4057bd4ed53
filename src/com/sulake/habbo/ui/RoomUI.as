package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1053:IRoomWidgetFactory;
      ...
      {
         this.var_1309 = RoomDesktop.const_496;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1053.release(new IIDHabboRoomWidget());
            this.var_1053 = null;
         }
         ...
         {
            this.var_539.release(new IIDHabboSoundManager());
            this.var_539 = null;
         }
         ...
         {
            this.var_845.release(new IIDHabboModeration());
            this.var_845 = null;
         }
         ...
         {
            this.var_390.release(new IIDSessionDataManager());
            this.var_390 = null;
         }
         ...
         if(this.var_1061)
         {
            this.var_1061.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1061 = null;
         }
         this.var_1649 = null;
         ...
         if(this.var_278)
         {
            ...
            {
               _loc1_ = this.var_278.getKey(0) as String;
               _loc2_ = this.var_278.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1053 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1649 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_277.events.addEventListener(AdEvent.const_393,this.adEventHandler);
            this.var_277.events.addEventListener(AdEvent.const_471,this.adEventHandler);
            this.var_277.events.addEventListener(AdEvent.const_482,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_845 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_845);
      }
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_539 = param2 as IHabboSoundManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_18)
         {
            this.var_18.events.addEventListener(RoomSessionEvent.const_239,this.roomSessionStateEventHandler);
            this.var_18.events.addEventListener(RoomSessionEvent.const_81,this.roomSessionStateEventHandler);
            this.var_18.events.addEventListener(RoomSessionEvent.const_94,this.roomSessionStateEventHandler);
            this.var_18.events.addEventListener(RoomSessionChatEvent.const_175,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionChatEvent.const_467,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionUserBadgesEvent.const_126,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionDoorbellEvent.const_111,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionDoorbellEvent.const_122,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionDoorbellEvent.const_40,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionPresentEvent.const_278,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionViralFurniStatusEvent.const_533,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionViralFurniStatusEvent.const_517,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_226,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_210,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_581,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_896,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_1026,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_219,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_206,this.roomSessionDialogEventHandler);
            ...
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_258,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_222,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_680,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_740,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_172,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_638,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_742,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionQueueEvent.const_522,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionVoteEvent.const_132,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionVoteEvent.const_128,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionPollEvent.const_121,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionPollEvent.const_65,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionPollEvent.const_134,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionDimmerPresetsEvent.const_395,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionFriendRequestEvent.const_125,this.roomSessionEventHandler);
         }
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_148,HabboToolbarIconEnum.ZOOM));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_148,HabboToolbarIconEnum.MEMENU));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_148,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_210:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_581:
            ...
            case RoomSessionErrorMessageEvent.const_680:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_740:
      ...
      {
         this.var_1061 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_596,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_626,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_420,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_398,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_283,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_750,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_236,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_602,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_575)
         {
            if(this.var_18 != null)
            {
               this.var_18.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_398 || param1.type == RoomEngineEvent.const_420)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_596:
               ...
               if(this.var_1309 != RoomDesktop.const_496)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_273,this.var_1309);
               }
               if(this.var_277 != null)
               {
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1053;
         _loc3_.sessionDataManager = this.var_390;
         ...
         _loc3_.avatarEditor = this.var_1649;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_277;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1060;
         _loc3_.moderation = this.var_845;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_539;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1061;
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_278.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_273);
            if(_loc3_ != RoomDesktop.const_496)
            {
               this.var_1309 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
      ...
      {
         return this.var_278.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_278.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
