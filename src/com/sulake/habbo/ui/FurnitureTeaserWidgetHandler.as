package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_763,RoomWidgetViralFurniMessage.const_784,RoomWidgetViralFurniMessage.const_150];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_763:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_469);
                     _loc7_.data = _loc6_;
            ...
            case RoomWidgetViralFurniMessage.const_784:
               ...
               break;
            case RoomWidgetViralFurniMessage.const_150:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_533,RoomSessionViralFurniStatusEvent.const_517];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_533:
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_517:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
