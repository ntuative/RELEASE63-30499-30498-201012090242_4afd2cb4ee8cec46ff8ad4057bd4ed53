   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_703,this.onFigureUpdate);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_404,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_703,this.onFigureUpdate);
         ...
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_955,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1022,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_404,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_999,HabboToolbarIconEnum.MEMENU);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_794);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_672);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_688);
         _loc1_.push(RoomWidgetStopEffectMessage.const_619);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1401);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1077);
         _loc1_.push(RoomWidgetToolbarMessage.const_693);
         _loc1_.push(RoomWidgetToolbarMessage.const_707);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_334);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1286);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1094);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_564);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_597);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_767);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1362);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_712);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_597:
               ...
               break;
            case RoomWidgetWaveMessage.const_794:
            ...
            case RoomWidgetSelectEffectMessage.const_669:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_688:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_996)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_185,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_672:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1106:
                        this._catalog.openCatalogPage(CatalogPageName.const_1379,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1019:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_288);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1478:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_77);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1458:
                        break;
                     default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1077:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_564:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_693:
            ...
            case RoomWidgetToolbarMessage.const_707:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_428,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_334:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_406));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_767:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_712:
            ...
            case RoomWidgetAvatarEditorMessage.const_685:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_401));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_317:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_735));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_665));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_404:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_531));
         }
      }
