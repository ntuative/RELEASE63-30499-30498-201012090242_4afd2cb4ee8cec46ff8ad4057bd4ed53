package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_560,RoomWidgetEcotronBoxOpenMessage.const_757,RoomWidgetEcotronBoxOpenedMessage.const_1373];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_560:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_757:
