package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_926);
               break;
            case RoomWidgetRoomQueueMessage.const_618:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1112);
               break;
      ...
      {
         return [RoomSessionQueueEvent.const_522];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_522:
               ...
               {
                  case RoomSessionQueueEvent.const_1112:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc7_.length > 1)
               {
                  ...
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1469) + 1;
                  }
               }
               else
               {
