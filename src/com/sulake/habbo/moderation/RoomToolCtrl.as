package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1303:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_44.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_309));
      ...
      public function populate() : void
      {
         ...
         this.var_1302 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1303 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_44,WindowTracker.const_731,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_44.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1280,_loc2_,this.var_441.text,"",""));
         if(this.var_1302.isSelected || this.var_1303.isSelected || this.var_838.isSelected)
         {
            this.var_44.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1302.isSelected,this.var_1303.isSelected,this.var_838.isSelected));
         }
         this.dispose();
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_44.initMsg.roomMessageTemplates[this.var_1049.selection];
         if(_loc3_ != null)
         {
            this.var_574 = false;
