package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1841:String = "picked_issues";
      
      private const const_1850:String = "closed_issues";
      ...
      private var var_1715:IIssueBrowserView;
      
      private var var_1717:IIssueBrowserView;
      
      private var var_1716:PickedIssuesView;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1840:
               ...
               {
                  this.var_1715 = new MyIssuesView(this.issueManager,this,this.var_243.container);
               }
               return this.var_1715;
            case this.const_1839:
               if(this.var_1717 == null)
               {
                  this.var_1717 = new OpenIssuesView(this.issueManager,this,this.var_243.container);
               }
               return this.var_1717;
            case this.const_1841:
               if(this.var_1716 == null)
               {
                  this.var_1716 = new PickedIssuesView(this.issueManager,this,this.var_243.container);
               }
