package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_827:int = 60;
      
      private static const const_826:int = 3600;
      
      private static const const_828:int = 86400;
      
      private static const const_825:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_827) + " mins ago";
         }
         ...
         {
            return Math.round(param1 / const_828) + " days ago";
         }
         return Math.round(param1 / const_825) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_944.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_44.getXmlWindow("user_info"));
            this.var_944.addChild(_loc1_);
            ...
            this.var_44.disableButton(this.var_44.initMsg.alertPermission || this.var_44.initMsg.kickPermission || this.var_44.initMsg.method_4,_loc1_,"modaction_but");
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_44,WindowTracker.const_944,this._data.userId),this._callerFrame,this.var_943,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new RoomVisitsCtrl(this.var_44,this._data.userId),this._callerFrame,this.var_943,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new SendMsgsCtrl(this.var_44,this._data.userId,this._data.userName,this.var_1244),this._callerFrame,this.var_943,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new ModActionCtrl(this.var_44,this._data.userId,this._data.userName,this.var_1244),this._callerFrame,this.var_943,false,true);
      }
