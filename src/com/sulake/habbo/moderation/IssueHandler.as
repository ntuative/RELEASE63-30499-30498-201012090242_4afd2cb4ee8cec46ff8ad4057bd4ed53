package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_459:UserInfoCtrl;
      
      private var var_1072:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_459 = new UserInfoCtrl(this._window,this.var_60,_loc3_.message);
         this.var_1072 = new UserInfoCtrl(this._window,this.var_60,_loc3_.message);
         this.var_459.load(IWindowContainer(this._window.findChildByName("caller_user_info")),this.var_122.getHighestPriorityIssue().reporterUserId);
         ...
         {
            this.var_1072.load(_loc4_,this.var_122.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_60 != null && this.var_60.issueManager != null && this.var_122 != null)
         {
            this.var_60.issueManager.removeHandler(this.var_122.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.closeBundle(this.var_122.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.closeBundle(this.var_122.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.closeBundle(this.var_122.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.releaseBundle(this.var_122.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_60,WindowTracker.const_1031,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_459 = new UserInfoCtrl(this._window,this.var_60,_loc3_.message);
            this.var_459.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
