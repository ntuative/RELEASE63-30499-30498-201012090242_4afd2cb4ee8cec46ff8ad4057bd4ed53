package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1431:IMessageComposer;
      ...
      {
         this.var_1040 = IWindowContainer(this.var_44.getXmlWindow("chatlog_roomheader"));
         this.var_1039 = IWindowContainer(this.var_44.getXmlWindow("chatlog_chatline"));
         ...
         this.var_44.connection.send(this.var_1431);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(this.var_1040.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_1039.clone());
         _loc4_.color = this.var_1613[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
