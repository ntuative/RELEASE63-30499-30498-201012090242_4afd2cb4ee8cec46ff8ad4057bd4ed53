package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_18 != null)
         {
            this.var_18.events.removeEventListener(RoomSessionEvent.const_81,this.roomSessionEventHandler);
            this.var_18.events.removeEventListener(RoomSessionEvent.const_94,this.roomSessionEventHandler);
            this.var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_538,this.roomSessionEventHandler);
      ...
      {
         return TradingModel(this.var_45.getValue(InventorySubCategory.const_275));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_45.getValue(InventoryCategory.const_599));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_45.getValue(InventoryCategory.const_288));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_45.getValue(InventoryCategory.const_372));
      }
      ...
      {
         return PetsModel(this.var_45.getValue(InventoryCategory.const_152));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_45.getValue(InventoryCategory.const_316) as MarketplaceModel;
      }
      ...
      {
         this.var_390 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_18.events.addEventListener(RoomSessionEvent.const_81,this.roomSessionEventHandler);
         this.var_18.events.addEventListener(RoomSessionEvent.const_94,this.roomSessionEventHandler);
         this.var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_538,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               this.var_1054 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_538:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_390 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_18 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_45.add(InventoryCategory.const_316,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_390);
         this.var_45.add(InventoryCategory.const_288,_loc3_);
         ...
         this.var_45.add(InventoryCategory.const_599,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_390);
         this.var_45.add(InventoryCategory.const_372,_loc5_);
         ...
         this.var_45.add(InventorySubCategory.const_275,_loc6_);
         ...
         this.var_45.add(InventoryCategory.const_152,_loc8_);
         this.var_173 = true;
         if(this.var_2311)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_841.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_841.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_841.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_955));
      }
