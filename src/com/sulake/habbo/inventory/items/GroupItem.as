package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_754:int = 0;
      
      protected var var_617:BitmapData;
      ...
      protected var var_2599:BitmapData;
      
      private const const_1807:int = 8947848;
      
      private const const_1806:int = 13421772;
      
      private const const_1555:Number = 1;
      
      private const const_1556:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_1863 = param7;
         this._items = new Map();
         this._mainCategory = param2;
         this._category = param3;
         this.var_1864 = param8;
         this.var_1712 = param9;
         if(param10 != null)
         {
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1712));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1864);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_754 = _loc1_.id;
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_605)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(this.var_1863 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2599;
               _loc5_.visible = true;
            }
            else
            {
