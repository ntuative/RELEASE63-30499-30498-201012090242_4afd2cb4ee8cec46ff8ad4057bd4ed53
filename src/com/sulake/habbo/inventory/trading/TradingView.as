package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_862:uint = 4284532064;
      
      private static const const_861:uint = 2577770;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1766 = this.createMinimizedWindow();
         }
         if(!this.var_2481)
         {
            return this.var_66;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_862) : uint(const_861);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_862) : uint(const_861);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_909)
            {
            ...
            this.var_395.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_455);
            this.var_395.show();
         }
