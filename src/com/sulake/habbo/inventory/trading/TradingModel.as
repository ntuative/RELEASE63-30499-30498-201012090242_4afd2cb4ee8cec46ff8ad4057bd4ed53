package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1415:uint = 9;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_730 = true;
         this.state = const_164;
         this.var_48.setup(param1,param3,param4,param6);
         this.var_48.updateItemList(this.var_656);
      ...
      public function close() : void
      {
         if(this.var_730)
         {
            if(this._state != const_167 && this._state != const_225)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_167;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_943);
            this.var_730 = false;
         }
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_657 + " OTHER: " + this.var_1004);
         ...
         {
            case const_167:
               if(param1 == const_164 || param1 == const_225)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         else if(param1 is TradingAcceptEvent)
         {
            ...
            if(TradingAcceptEvent(param1).userID == this.var_656)
            {
               this.var_657 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1004 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_48.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_656)
            {
               this.var_48.alertPopup(TradingView.const_950);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_265.length < const_1415)
         {
