package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1848:int = 0;
      ...
      private const const_1540:int = 42;
      
      private const const_1542:int = 120;
      ...
      private var var_706:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_435.add(FurniModel.const_41,new FurniGridView(this.var_62,FurniModel.const_41,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_435.add(FurniModel.const_45,new FurniGridView(this.var_62,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case FurniModel.const_338:
               ...
               this.var_369 = FurniModel.const_338;
               break;
            default:
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_435.getValue(this.var_369);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_62.getCategoryContent(this.var_369);
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_62.getGroupItemInIndex(_loc3_,this.var_369);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_706 && this.var_706.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1542)
         {
            _loc3_ = this.const_1542;
         }
         else if(_loc3_ < this.const_1540)
         {
