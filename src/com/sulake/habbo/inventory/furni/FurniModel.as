package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1222:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_236,this.onObjectPlaced);
         this._catalog = param7;
         this.var_585 = new Timer(const_1222,1);
         this.var_585.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2453 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_236,this.onObjectPlaced);
               }
            ...
            {
               this.var_585.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_585.stop();
               this.var_585 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_877 == null)
         {
            this.var_877 = this._windowManager.buildFromXML(this.var_2453) as IWindowContainer;
         }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_316);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_469.add(const_41,new Array());
         this.var_469.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_360 || _loc3_.category == FurniCategory.const_368 || _loc3_.category == FurniCategory.const_366)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1348 && param1.type == RoomEngineObjectEvent.const_236)
         {
            this.var_1348 = false;
         }
      }
      ...
      {
         return this.var_469.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_469.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_469.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
