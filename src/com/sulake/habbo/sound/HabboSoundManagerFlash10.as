package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_873:TraxSequencer;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1050,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_874.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               ...
               case HabboSoundTypesEnum.const_1250:
                  ...
                  break;
               case HabboSoundTypesEnum.const_953:
            ...
            this.var_874.add(param1,_loc2_);
         }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_153.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_153.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_580.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_709.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_709,events);
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_872.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_872 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_153 == null || this._connection == null || this._roomEngine == null || this.var_579 != null)
         {
            return;
         }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_580.getValue(_loc2_);
         ...
         this.var_580.remove(_loc2_);
         this.var_709.add(_loc3_,_loc6_);
         if(this.var_580.length == 0 && this.var_708 != -1)
         {
            this.var_873.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1050,this.var_708));
            this.var_708 = -1;
            this.var_873 = null;
         }
      }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1298,this.var_708));
         this.var_708 = -1;
         this.var_873 = null;
      }
      ...
      {
         this.var_464 = param1;
         this.var_579.updateVolume(this.var_464);
