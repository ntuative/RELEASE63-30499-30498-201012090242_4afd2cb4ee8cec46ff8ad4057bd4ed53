package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1560:String = "type_jukebox";
      
      private var var_539:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_637,this.onSongFinishedPlayingEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_776,this.onSoundMachinePlayEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_689,this.onSoundMachineStopEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_687,this.onJukeboxInitEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_475,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_637,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_87)
            {
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_776,this.onSoundMachinePlayEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_689,this.onSoundMachineStopEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_687,this.onJukeboxInitEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_475,this.onDisposeEvent);
               this.var_87 = null;
            }
            if(this.var_382)
            {
      ...
      {
         this.startPlaying(this.const_1560);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_270 = _loc2_.id;
            this.playSong(this.var_270);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_382[this.var_270] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_382.getValue(this.var_270) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_270 = param1;
         var _loc2_:IHabboSound = this.var_382.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_539.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_539.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_270)
         {
            _loc6_ = this.var_382[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1616 == this.const_1560)
         {
            this.var_75.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_)
         {
            _loc7_ = this.var_382[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_539.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_382.add(_loc3_.id,_loc7_);
            }
