package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_406:AssetLibrary;
      
      protected var var_744:XML;
      
      protected var _name:String;
      
      private var var_510:uint = 0;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_406 = new AssetLibrary("lib-" + this.var_510++);
         this.var_28.push(this.var_406);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_510++);
         this.var_500.push(_loc3_);
      ...
      {
         return this.var_406.loadFromResource(param1,param2);
      }
      ...
      public function unload() : void
      {
         ...
         {
            (this.var_500.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_500.length)
            {
               _loc3_ = this.var_500[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  this.var_500.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return this.var_406.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_406.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_406.createAsset(param1,param2);
      }
      ...
      {
         return this.var_406.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_406.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_406.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_28.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_406.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_28.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
