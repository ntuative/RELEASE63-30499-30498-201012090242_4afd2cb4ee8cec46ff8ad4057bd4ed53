package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_446:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_446 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_113 is BitmapDataAsset)
         {
            ...
            this.var_1378 = BitmapDataAsset(this.var_113).var_1378;
            this.var_1377 = BitmapDataAsset(this.var_113).var_1377;
            if(this._bitmap != null)
            {
               this.var_113 = null;
               return;
