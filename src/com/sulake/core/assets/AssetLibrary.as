package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_982:String = "AssetLibraryReady";
      
      public static const const_713:String = "AssetLibraryLoaded";
      
      public static const const_1261:String = "AssetLibraryUnloaded";
      
      public static const const_1341:String = "AssetLibraryLoadError";
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_497;
         this.var_404 = new Dictionary(false);
         this.var_498 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_917.splice(var_917.indexOf(this),1);
            --var_497;
            this.var_498 = null;
            this.var_915 = null;
            this.var_149 = null;
      ...
      {
         if(this._file == param1.url && this.var_916)
         {
            if(!this.var_914 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_744,this.var_614);
            }
            this.var_914 = param2;
            dispatchEvent(new Event(AssetLibrary.const_982));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_916 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1261));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_498[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1109,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_961,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_977,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_498[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_498[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_498[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_149[param1] != null || (this.var_614 != null ? this.var_614[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_404.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_404[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_404[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_404)
         {
            _loc3_ = AssetTypeDeclaration(this.var_404[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_404)
         {
            _loc4_ = AssetTypeDeclaration(this.var_404[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_744 = _loc2_.manifest.copy();
         this.var_614 = _loc2_.resource;
         ...
         this.var_916 = true;
         dispatchEvent(new Event(AssetLibrary.const_713));
         dispatchEvent(new Event(AssetLibrary.const_982));
         if(this.var_914)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1341));
         this.var_39 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_744.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_614[param1]);
