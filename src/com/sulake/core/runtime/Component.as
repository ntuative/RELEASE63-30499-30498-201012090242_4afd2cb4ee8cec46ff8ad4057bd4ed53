package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1001:uint = 4;
      ...
      private var var_442:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_442 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_442.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_442.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1155 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1155);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1403 & const_1001)
         {
            if(_loc3_ == 0)
            {
               if(this.var_442.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_442.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_442.getStructByIndex(_loc8_);
