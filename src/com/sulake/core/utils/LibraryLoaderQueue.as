package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      {
         return this.var_383.length + this.var_252.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_252.length < const_1516 && this.var_383.length > 0)
            {
               _loc1_ = this.var_383.shift();
               this.var_252.push(_loc1_);
               _loc1_.resume();
            }
         }
      }
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            index = this.var_383.indexOf(loader);
            if(index > -1)
            {
               this.var_383.splice(index,1);
            }
            index = this.var_252.indexOf(loader);
            if(index > -1)
            {
               this.var_252.splice(index,1);
            }
         }
         catch(e:Error)
         {
