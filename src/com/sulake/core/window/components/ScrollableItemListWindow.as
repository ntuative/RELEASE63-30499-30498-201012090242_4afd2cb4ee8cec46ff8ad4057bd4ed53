package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_356)
         {
            this.var_356.removeEventListener(WindowEvent.const_298,this.scrollBarEventProc);
            this.var_356.removeEventListener(WindowEvent.const_228,this.scrollBarEventProc);
            this.var_356 = null;
         }
         if(this.var_951)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_951)
         {
            this.var_951 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return this.var_951;
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_356)
         {
            this.var_356 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_356)
            {
               this.var_356.addEventListener(WindowEvent.const_298,this.scrollBarEventProc);
               this.var_356.addEventListener(WindowEvent.const_228,this.scrollBarEventProc);
            }
         }
         return this.var_356;
      }
