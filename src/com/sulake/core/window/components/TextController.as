package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1523:Array = [AntiAliasType.ADVANCED,AntiAliasType.NORMAL];
      
      protected static const const_1522:Array = [GridFitType.PIXEL,GridFitType.NONE,GridFitType.SUBPIXEL];
      
      protected static const const_1521:Array = [TextFieldAutoSize.NONE,TextFieldAutoSize.LEFT,TextFieldAutoSize.RIGHT,TextFieldAutoSize.CENTER];
      ...
      protected var var_411:String = "none";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_386,this.var_201);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            ...
            setTextFormatting(param1._field,param1.var_386,param1.var_201);
            param1.refreshTextImage();
         }
      }
      ...
      {
         this.var_756 = param1;
         this._field.scrollH = this.var_756 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_756 * this.maxScrollH,this.var_503 * this.maxScrollV,width,height);
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(this.var_411 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
            else if(this.var_411 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
            else if(this.var_411 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(this.var_411 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:Object = TextStyleManager.getStyle(this.var_386);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_308,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(new PropertyStruct("text_color",this._field.textColor,PropertyStruct.const_174,this._field.textColor != _loc2_.color));
         _loc1_.push(new PropertyStruct("antialias_type",this._field.antiAliasType,PropertyStruct.const_88,this._field.antiAliasType != AntiAliasType.ADVANCED,const_1523));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_88,this._field.gridFitType != GridFitType.PIXEL,const_1522));
         ...
         _loc1_.push(new PropertyStruct("text_style",this.var_386,PropertyStruct.const_88,this.var_386 != TextStyleManager.const_319,STYLE_SHEET_RANGE));
         ...
         _loc1_.push(new PropertyStruct("auto_size",this.var_411,PropertyStruct.const_88,this.var_411 != TextFieldAutoSize.NONE,const_1521));
