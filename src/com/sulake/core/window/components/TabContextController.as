package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1148:String = "_SELECTOR";
      
      private static const const_1149:String = "_CONTENT";
       
      
      protected var var_924:ITabSelectorWindow;
      
      protected var var_1859:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_924 = findChildByTag(const_1148) as ITabSelectorWindow;
            if(this.var_924 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1859 = findChildByTag(const_1149) as IWindowContainer;
         }
      ...
      {
         return !!this.var_734 ? this.selector.iterator : null;
      }
