package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         else if(param2.type == WindowNotifyEvent.const_753)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_751;
         if(this.var_751 != param1)
         {
            if(this.var_751 != null)
            {
               if(!this.var_751.disposed)
               {
                  this.var_751.deactivate();
               }
            }
            this.var_751 = param1;
