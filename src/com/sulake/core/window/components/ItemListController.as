package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1878:Boolean = false;
      ...
      protected var var_2654:Number = 0.0;
      
      protected var var_2655:Number = 0.0;
      ...
      protected var var_1876:int = 0;
      
      protected var var_1877:int = 0;
      
      protected var var_1165:Number;
      
      protected var var_1168:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_98 = 0;
         this.var_90 = 0;
         this._horizontal = param2 == WindowType.const_369;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_150 = var_413 || !testParamFlag(WindowParam.const_31);
         this._container = var_16.create("_CONTAINER","",WindowType.const_324,WindowStyle.const_808,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_44,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_498,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_265,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_436,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1166;
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_619)
         {
            ...
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_70);
            dispatchEvent(new WindowEvent(WindowEvent.const_462,this,null));
         }
      }
      ...
      {
         this.var_2654 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2655 = Math.max(param1,0);
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_498,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_265,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_171:
               if(this.var_1167)
               {
                  this.var_1165 = this.var_1876 - _loc3_;
                  this.var_1168 = this.var_1877 - _loc4_;
                  if(this._horizontal)
                  {
                  ...
                  else if(this.var_1168 != 0 && this.var_90 != 0)
                  {
                     this.scrollV += this.var_1168 / this.var_90;
                  }
                  this.var_1876 = _loc3_;
                  this.var_1877 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_178:
               if(this.var_1167)
               {
                  ...
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1168);
                  }
                  this.var_1167 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_928 && !this.var_506 && this._container)
         {
            this.var_506 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1121,this._spacing,PropertyStruct.const_53,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1120,this.var_928,PropertyStruct.const_50,this.var_928 != const_1526));
         _loc1_.push(new PropertyStruct(const_1119,this.var_507,PropertyStruct.const_50,this.var_507 != const_1525));
         _loc1_.push(new PropertyStruct(const_1118,this.var_1166,PropertyStruct.const_50,this.var_1166 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
