package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1515:uint = 500;
      
      protected static var var_257:Array;
       
      
      protected var var_2600:uint = 0;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_408[0] = MouseCursorType.const_354;
         this.var_408[1] = MouseCursorType.const_34;
         this.var_408[2] = MouseCursorType.const_354;
         this.var_408[3] = MouseCursorType.const_354;
         this.var_408[4] = MouseCursorType.const_34;
         this.var_408[5] = MouseCursorType.const_34;
         this.var_408[6] = MouseCursorType.const_354;
         if(var_257 == null)
         {
            var_257 = new Array();
            ...
            var_257[5] = WindowState.const_85;
            var_257[6] = WindowState.const_68;
         }
      ...
      public static function processInteractiveWindowEvents(param1:IInteractiveWindow, param2:Event) : void
      {
         if(param1.toolTipCaption != const_820)
         {
            ...
            else if(param2.type != WindowMouseEvent.const_171)
            {
      ...
      {
         param2.push(new PropertyStruct(const_1116,param1.toolTipCaption,PropertyStruct.const_88,param1.toolTipCaption != const_820));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_308,param1.toolTipDelay != const_1515));
         return param2;
      }
      ...
      {
         this.var_1149 = param1 == null ? const_820 : param1;
      }
