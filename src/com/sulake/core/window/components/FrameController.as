package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1221:String = "_TITLE";
      
      private static const const_1229:String = "_HEADER";
      
      private static const const_1231:String = "_CONTENT";
      
      private static const const_1230:String = "_SCALER";
      
      private static const const_869:String = "margin_left";
      
      private static const const_868:String = "margin_top";
      
      private static const const_867:String = "margin_right";
      
      private static const const_870:String = "margin_bottom";
      ...
      public function get title() : ITextWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1221) as ITextWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1368 = findChildByTag(const_1229) as IHeaderWindow;
            if(!this.var_1368)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_165 = findChildByTag(const_1231) as IWindowContainer;
            if(!this.var_165)
            {
      ...
      {
         return findChildByTag(const_1230) as IScalerWindow;
      }
      ...
      {
         return this.content != null && this.var_927 ? this.content.iterator : new Iterator(this);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_869,_loc3_.left,PropertyStruct.const_53,_loc2_));
         _loc1_.push(new PropertyStruct(const_868,_loc3_.top,PropertyStruct.const_53,_loc2_));
         _loc1_.push(new PropertyStruct(const_867,0 - _loc3_.right,PropertyStruct.const_53,_loc2_));
         _loc1_.push(new PropertyStruct(const_870,0 - _loc3_.bottom,PropertyStruct.const_53,_loc2_));
         return _loc1_;
      }
