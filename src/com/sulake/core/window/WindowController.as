package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1110:uint = 0;
      ...
      protected static const const_1527:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1359:Point = new Point();
      ...
      protected var var_759:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(param7 != null)
         {
            ...
            if(this.var_21)
            {
               var_16.invalidate(this,var_11,WindowRedrawFlag.const_70);
            }
         }
      }
      ...
      {
         return this.var_759 != null ? this.var_759 : (this.var_13 != null ? this.var_13.procedure : this.nullEventProc);
      }
      ...
      {
         var_413 = param1;
         var_215 = !!var_413 ? uint(var_215 | var_508) : uint(var_215 & 16777215);
      ...
      {
         var_508 = param1 << 24;
         var_215 = !!var_413 ? uint(var_508 | var_215) : uint(16777215 & var_215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_70);
      }
      
      public function set blend(param1:Number) : void
      {
         var_644 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_984);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this.var_13 != param1)
         {
            ...
            if(this.var_13 != null)
            {
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_403,this,this.var_13));
            }
            else
            {
               this.var_332.x = 0;
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1115,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_583,var_11);
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,var_20,var_16,var_11,null,this.var_759,this.properties,var_761.concat(),_id) as WindowController;
         ...
         _loc2_.var_760 = var_760;
         _loc2_.var_348 = var_348;
         _loc2_.var_644 = var_644;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2474 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_16.invalidate(this,param1,WindowRedrawFlag.const_70);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1009,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_565,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_662))
         {
            ...
            switch(param2.type)
            {
               case WindowMouseEvent.const_38:
                  ...
                  if(testParamFlag(WindowParam.const_321))
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_224))
                        {
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_186:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_183,WindowParam.const_143))
                     {
               ...
               case WindowNotifyEvent.const_422:
                  var_16.invalidate(this,var_11.union(var_56),WindowRedrawFlag.const_454);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1057,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_296,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_332:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_753,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_217,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_431:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_895);
                  break;
               case WindowNotifyEvent.const_468:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1527) == -1)
                     {
                        _loc8_.style = var_79;
                     }
                  }
               ...
               case WindowNotifyEvent.const_477:
                  if(!(var_20 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_16.invalidate(this,var_11,WindowRedrawFlag.const_454);
                     }
                  }
                  else if(var_20 & 0)
                  {
         ...
         if(this.var_150 && var_414 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1359,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1359,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_130,WindowParam.const_143);
         var _loc2_:* = !testParamFlag(WindowParam.const_118,WindowParam.const_149);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               ...
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_379)
               {
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1108,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1358 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1358 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_762,this,param1));
         return param1;
      }
