package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_552:String = "}";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_319],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_319] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_552);
         if(countSubStrings(param1,TAG_OPEN) != countSubStrings(param1,const_552))
         {
            throw new Error("Mismatching amount of \"" + TAG_OPEN + "\" versus \"" + const_552 + "\", please check the CSS!");
         }
