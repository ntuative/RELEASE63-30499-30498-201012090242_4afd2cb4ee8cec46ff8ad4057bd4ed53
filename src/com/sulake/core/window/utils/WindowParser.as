package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1802:String = "_INCLUDE";
      
      public static const const_1712:String = "_TEMP";
      
      private static const const_1178:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1177:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_925:Dictionary;
      
      protected var var_1407:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1158);
         this.var_925 = new Dictionary();
         this.var_1407 = new Dictionary();
         ParamCodeTable.fillTables(this.var_925,this.var_1407);
         this.var_1865 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1177,"");
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1158)
            {
               delete this.var_1158[_loc1_];
            }
            for(_loc1_ in this.var_925)
            {
               delete this.var_925[_loc1_];
            }
            for(_loc1_ in this.var_1407)
            {
               delete this.var_1407[_loc1_];
            }
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         window = this.var_16.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.method_8(xml.child("variables")[0]),tags) as WindowController;
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1158[param1.type];
