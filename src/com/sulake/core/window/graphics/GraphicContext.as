package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1364:uint = 0;
      
      public static const const_583:uint = 1;
      
      public static const const_956:uint = 2;
      
      public static const const_723:uint = 4;
      
      public static const const_1399:uint = 8;
      
      public static const const_1503:uint = 16;
      
      public static const const_1704:uint = 64;
      
      public static const const_1756:uint = 128;
      
      public static const const_1062:uint = 256;
      
      protected static var var_510:uint = 0;
         ...
         if(this.var_755)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1866,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1866,16777215);
                  }
                  var_290 += bitmap.width * bitmap.height * 4;
               }
