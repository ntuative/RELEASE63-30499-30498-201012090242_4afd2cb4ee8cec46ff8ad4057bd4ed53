         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  _loc13_.x += param3.x;
                  _loc13_.y += param3.y;
                  if(_loc11_.scaleH == SkinLayoutEntity.const_302)
                  {
                     _loc13_.x += _loc16_;
                  }
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_508)
                  {
                     _loc14_ = true;
                  ...
                  if(_loc11_.scaleV == SkinLayoutEntity.const_302)
                  {
                     _loc13_.y += _loc17_;
                  }
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_508)
                  {
                     _loc15_ = true;
                  ...
                  {
                     this.var_883.a = _loc13_.width / _loc19_.width;
                     this.var_883.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,this.var_883);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,this.var_883,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_302)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_302)
               {
