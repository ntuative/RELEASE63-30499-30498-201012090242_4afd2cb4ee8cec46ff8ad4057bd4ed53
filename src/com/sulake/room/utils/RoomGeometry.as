package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_656:Number = 64;
      
      public static const const_891:Number = 32;
      ...
      private var var_1495:Number = 1.0;
      ...
      private var var_2621:Number = -500.0;
      
      private var var_2622:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1494 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_73.x * this.var_365,this.var_73.y * this.var_364,this.var_73.z * this.var_366);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_225.x,this.var_225.y,this.var_225.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_365 != param1 * this.var_1495)
         {
            this.var_365 = param1 * this.var_1495;
            ++this.var_135;
         }
      }
      ...
      {
         if(this.var_364 != param1 * this.var_1493)
         {
            this.var_364 = param1 * this.var_1493;
            ++this.var_135;
         }
      }
      ...
      {
         if(this.var_366 != param1 * this.var_1494)
         {
            this.var_366 = param1 * this.var_1494;
            ++this.var_135;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_73.x /= this.var_365;
         this.var_73.y /= this.var_364;
         this.var_73.z /= this.var_366;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_225.x;
         var _loc3_:Number = this.var_225.y;
         var _loc4_:Number = this.var_225.z;
         this.var_225.assign(param1);
         if(this.var_225.x != _loc2_ || this.var_225.y != _loc3_ || this.var_225.z != _loc4_)
         {
            ++this.var_135;
         }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_365;
         _loc2_.y *= this.var_364;
         _loc2_.z *= this.var_366;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_976);
         if(_loc3_ < this.var_2621 || _loc3_ > this.var_2622)
         {
            return null;
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_73.x * this.var_365,this.var_73.y * this.var_364,this.var_73.z * this.var_366);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_159;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_365,param2.y * this.var_364,param2.z * this.var_366);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_365,param3.y * this.var_364,param3.z * this.var_366);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_365,param4.y * this.var_364,param4.z * this.var_366);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_891;
         }
         else
         {
            this.scale = const_656;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_656;
      }
