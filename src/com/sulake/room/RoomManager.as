package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2680:IRoomContentLoader;
      
      private var var_599:IRoomObjectFactory = null;
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_599 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_599 == null || this.var_480 == null)
         {
            return;
         }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_546.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_546[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_480.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_480.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_599.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_599 != null)
         {
            return this.var_599.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_609)
         {
            return;
         }
         if(this.var_47 == null)
         {
            this._state = const_609;
            return;
         }
         if(this.var_47.getGraphicAssetCollection(param1) != null)
         {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_47 == null || this.var_480 == null)
         {
            return;
         }
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_480.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_480.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_599.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(this.var_148 != null)
                                 {
                                    this.var_148.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
