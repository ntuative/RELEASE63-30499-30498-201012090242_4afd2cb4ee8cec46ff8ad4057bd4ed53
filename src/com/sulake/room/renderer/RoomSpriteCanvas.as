package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1544:int = 50;
      ...
      private var var_533:RoomObjectCache;
      
      private var var_438:Array;
      
      private var var_530:Array;
      
      private var var_1230:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2092:Number = -1.0E7;
      
      private var var_2095:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_227.addChild(this.var_52);
         ...
         this.var_533 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_437.x -= param1 - this.var_529;
         this.var_529 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_437.y -= param1 - this.var_532;
         this.var_532 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_852 = true;
            if(this.var_117 != null && !this.var_227.contains(this.var_117))
            {
               this.var_227.addChild(this.var_117);
               this.var_52.mask = this.var_117;
            }
         }
         else if(!param1 && this.var_852)
         {
            this.var_852 = false;
            if(this.var_117 != null && this.var_227.contains(this.var_117))
            {
               this.var_227.removeChild(this.var_117);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_530.length)
            {
               this.cleanSprite(this.var_530[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_530 = [];
         }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_117 != null)
         {
            this.var_117.graphics.clear();
         }
         else
         {
            this.var_117 = new Sprite();
            this.var_117.name = "mask";
            if(this.var_852)
            {
               this.var_227.addChild(this.var_117);
               this.var_52.mask = this.var_117;
         ...
         this.var_117.graphics.beginFill(0);
         this.var_117.graphics.drawRect(0,0,param1,param2);
         this.var_648 = param1;
         this._ht = param2;
      }
      ...
      {
         this.var_533.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_648 != this.var_2096 || this._ht != this.var_2093)
         {
            _loc9_ = true;
         }
         if(this.var_52.x != this.var_529 || this.var_52.y != this.var_532)
         {
            this.var_52.x = this.var_529;
            this.var_52.y = this.var_532;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_438.sortOn("z",0 | 0);
         if(_loc5_ < this.var_438.length)
         {
            this.var_438.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_438[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2096 = this.var_648;
         this.var_2093 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_533.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_533.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_529;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_532;
                  if(_loc19_ < this.var_648 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_438.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_529;
                     _loc17_.y = _loc20_ - this.var_532;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_530.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_647 || this.var_647 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_438.length)
         {
            return null;
         }
         return this.var_438[param1] as SortableSprite;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_985 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1538;
         }
         this.var_1538 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_985;
         return this.var_1538;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_648 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1537,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_531.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_531.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2092 || param2 != this.var_2095)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_531.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_531.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_298.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1230.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
