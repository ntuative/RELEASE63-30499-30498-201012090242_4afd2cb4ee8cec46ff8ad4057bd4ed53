package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1707 || param2 != this.var_1708)
         {
      ...
      {
         if(this.var_1341 > 255 || bitmapData == null)
         {
            return false;
         }
